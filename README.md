...
----------- | ----------- | -------------- | --------------- | --------
Azure Identity and Activity | This template is used to analyze AAD logs and Azure Activity Logs to find malicious for AAD identity and unexpected Azure Resoruce operations  | AuditLogs    <Br/>SigninLogsAzure    <Br/>Activity | | <a href="https://portal.azure.cn/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FSimonXin%2Fsentinel-like-queries-for-mooncake%2Fmaster%2Ftemplate%2FIdentity_Activity.json" target="_blank"><img src="http://azuredeploy.net/deploybutton.png" width="326" height="36"></a>
...
Virtual Machine | This template is used to analyze security logs collected on Azure VM to find weak configuration and detect malicious attacks. Optionally, combined using Azure Security Center data anlaytics to link security alert with affected VMs and provide overview of VM protection status | SecurityEvent   <Br/>Syslog   <Br/>Update | SecurityBaseline   <Br/>SecurityBaselineSummary   <Br/>SecurityAlert   <Br/>ProtectionStatus | <a href="https://portal.azure.cn/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FSimonXin%2Fsentinel-like-queries-for-mooncake%2Fmaster%2Ftemplate%2Fazurevm.json" target="_blank"><img src="http://azuredeploy.net/deploybutton.png" width="326" height="36"></a>
